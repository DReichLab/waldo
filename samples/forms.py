	...
	def __init__(self, *args, **kwargs):
		...
		if self.instance.pk:
			...
			if sample:
				...
				self.fields['location'].initial = get_value(sample, 'location_fk', 'locality_str')
