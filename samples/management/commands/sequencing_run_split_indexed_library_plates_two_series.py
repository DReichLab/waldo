...
from samples.sequencing_run_partial import create_sequencing_run_two_series

class Command(BaseCommand):
	help = "Create multiple sequencing runs from indexed library plates (capture or shotgun) based on column plate position, for sequencing runs split into columns 1-6 and 7-12."
	...
	def handle(self, *args, **options):
		...
		create_sequencing_run_two_series(options['capture_names'], options['sequencing_run'], user)
