# Generated by Django 2.1.8 on 2019-12-02 19:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modification_timestamp', models.DateTimeField(default=django.utils.timezone.now)),
                ('modified_by', models.CharField(max_length=20)),
                ('reich_lab_id', models.PositiveIntegerField(db_index=True, help_text=' assigned when a sample is selected from the queue by the wetlab', unique=True)),
