# Generated by Django 3.0.3 on 2020-03-10 15:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plate_storage', models.CharField(blank=True, max_length=50)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('skeletal_code_renamed', models.CharField(blank=True, help_text='Sample identification code assigned by the Reich Lab', max_length=150)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tube_barcode', models.CharField(blank=True, help_text='Physical barcode on tube', max_length=10)),
                ('notes', models.TextField(blank=True)),
                ('extract_batch', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='samples.ExtractBatch')),
