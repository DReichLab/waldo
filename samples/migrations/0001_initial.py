# Generated by Django 2.1.8 on 2020-01-22 19:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modification_timestamp', models.DateTimeField(default=django.utils.timezone.now)),
                ('modified_by', models.CharField(max_length=20)),
                ('library_id', models.CharField(db_index=True, max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modification_timestamp', models.DateTimeField(default=django.utils.timezone.now)),
                ('modified_by', models.CharField(max_length=20)),
                ('reich_lab_id', models.PositiveIntegerField(db_index=True, help_text=' assigned when a sample is selected from the queue by the wetlab', null=True, unique=True)),
