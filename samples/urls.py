...
urlpatterns = [
	...
	path('sample_archaeology_sites', SiteListView.as_view(), name='sample_archaeology_sites'),
	path('sample_archaeology_site', views.sample_archaeology_site, name='sample_archaeology_site'),
	path('sample_archaeology_site_edit/<int:site_pk>', SiteEdit.as_view(), name='sample_archaeology_site_edit'),
	path('sample_archaeology_site_create', views.SiteCreate.as_view(), name='sample_archaeology_site_create'),
	...
	path('sample_archaeology_period_delete', views.sample_archaeology_period_delete, name='sample_archaeology_period_delete'),
	...
	path('sample_archaeology_culture_delete', views.sample_archaeology_culture_delete, name='sample_archaeology_culture_delete'),
	path('sample_edit', views.sample_edit, name='sample_edit'),
	path('sample_archaeology_anno', views.sample_archaeology_anno, name='sample_archaeology_anno'),
	path('genetic_analysis_new_headers', views.genetic_analysis_new_headers, name='genetic_analysis_new_headers'),
	path('genetic_analysis_new', views.genetic_analysis_new, name='genetic_analysis_new'),
	path('genetic_analysis_assessment_update_headers', views.genetic_analysis_assessment_update_headers, name='genetic_analysis_assessment_update_headers'),
	path('genetic_analysis_assessment_update', views.genetic_analysis_assessment_update, name='genetic_analysis_assessment_update'),
	path('publication_update_headers', views.publication_update_headers, name='publication_update_headers'),
	path('publication_update', views.publication_update, name='publication_update'),
