...
urlpatterns = [
	...
	path('extract_batch_assign_powder_batches', views.extract_batch_assign_powder_batches, name='extract_batch_assign_powder_batches'),
	path('extract_batch_plate_layout_initial', views.extract_batch_plate_layout_initial, name='extract_batch_plate_layout_initial'),
