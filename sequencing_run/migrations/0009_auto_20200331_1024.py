    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mt_bam', models.CharField(blank=True, max_length=300)),
                ('mt_fasta', models.CharField(blank=True, max_length=300)),
                ('nuclear_bam', models.CharField(blank=True, max_length=300)),
            ],
            options={
                'abstract': False,
            },
